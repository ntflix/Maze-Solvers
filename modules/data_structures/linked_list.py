...
class LinkedList(Generic[T]):
    head: Optional[LinkedListNode[T]] = None
    ...
    def __init__(self, nodes: list[T]) -> None:
        ...
        >>> myLinkedList = LinkedList[str](['Consecotaleophobia', 'is', 'the', 'fear', 'of', 'chopsticks.'])
        >>> [listItem.data for listItem in myLinkedList][0]
        'Consecotaleophobia'
        """
    ...
    def __iter__(self) -> Generator[LinkedListNode[T], None, None]:
        ...
        if self.head is not None:
            ...
            node: Optional[LinkedListNode[T]] = self.head
    ...
    def insertAtBeginning(self, node: LinkedListNode[T]) -> None:
    ...
    def extend(self, node: LinkedListNode[T], insertOnto: Optional[LinkedListNode[T]] = None) -> None:
        ...
        Args:
            ...
            insertOnto (Optional[LinkedListNode[T]]): The node or chain of nodes to insert `node` onto the end of. Don't worry about this if you simply want to insert onto the end of the `LinkedList` because it traverses that automatically. Defaults to `self.head`.
